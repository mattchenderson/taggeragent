...
|-----------|----------|----------|
| Architecture & design | Ripley | System design, component boundaries, API contracts |
| C# implementation (agent core) | Dallas | Agent logic, tagging engine, Foundry integration |
| C# implementation (functions/services) | Brett | Azure Functions, service integration, shared contracts |
| Infrastructure & deployment | Parker | azd, Bicep, managed identity, RBAC, CI/CD |
| Code review | Ripley | Review PRs, check quality, suggest improvements |
| Testing | Kane | Write tests, find edge cases, verify fixes |
...
| `squad:ripley` | Architecture/design issue | Ripley |
| `squad:dallas` | Agent core implementation issue | Dallas |
| `squad:brett` | Functions/service implementation issue | Brett |
| `squad:parker` | Infrastructure/deployment issue | Parker |
| `squad:kane` | Testing issue | Kane |
